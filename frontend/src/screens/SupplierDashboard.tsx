...
import { Truck, DollarSign, Star, Plus, BarChart3, Store, Shield, Package } from 'lucide-react';
    ...
    const renderContent = () => {
      ...
      <div className="p-4">
        ...
        />
            ...
            case 'profile':
                 return (<div className="p-4"><div className="bg-white rounded-lg shadow-sm p-4 mb-4"><div className="flex items-center space-x-4"><div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center"><Store className="w-8 h-8 text-green-600" /></div><div><h3 className="font-semibold text-lg">Ram Fresh Supplies</h3><p className="text-sm text-gray-600">Wholesale Supplier • Noida</p><div className="flex items-center space-x-1 mt-1 text-green-600"><Shield className="w-4 h-4" /><span className="text-sm font-medium">Verified Supplier</span></div></div></div></div><TrustScore score={87} badges={['Verified Supplier', 'Top Rated', '100+ Orders', 'Fast Delivery']} /></div>);
            default:
